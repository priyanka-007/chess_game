...
// chat
const whiteSelectorBtn = document.querySelector('#white-selector')
const blackSelectorBtn = document.querySelector('#black-selector')
...
const createChatMessageElement = (message) => `
  <div class="message ${message.sender === 'White' ? 'blue-bg' : 'gray-bg'}">
...
whiteSelectorBtn.onclick = () => updateMessageSender('White')
blackSelectorBtn.onclick = () => updateMessageSender('Black')
